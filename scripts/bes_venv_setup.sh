...
function main()
{
  ...
  ${_best} pip_project install_requirements --root-dir "${_projects_root_dir}" bes "${_requirements}"
  ${_best} pip_project install_requirements --root-dir "${_projects_root_dir}" bes "${_requirements_test}"
