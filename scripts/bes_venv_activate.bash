...
{
  source $(_this_dir_venv_activate)/../bes_shell/bes_all.sh

  local _this_dir="$(_this_dir_venv_activate)"
...
function _this_dir_venv_activate()
{
...
unset -f _this_dir_venv_activate
