...
class archive_tester(object):
  ...
  def test_extract_all(self):
    ...
    self._unit_test.assertTrue( path.isfile(path.join(tmp_dir, self.native_filename('foo.txt'))) )
  ...
  def test_extract_all_with_base_dir(self):
    ...
    self._unit_test.assertTrue( path.isfile(path.join(tmp_dir, base_dir, self.native_filename('foo.txt'))) )
  ...
  def test_extract_all_with_base_dir_and_strip_common_ancestor(self):
    ...
    self._unit_test.assertTrue( path.isfile(path.join(tmp_dir, base_dir_to_add, self.native_filename('foo.txt'))) )
