...
class test_refactor_ast(unit_test):
  ...
  def test_resolve_python_files(self):
    ...
    ], refactor_ast.resolve_python_files([ path.join(tmp_dir, f) for f in [ 'fruit', 'wine', 'foo.py' ] ]) )
  ...
  def test_resolve_text_files(self):
    ...
    self.assert_filename_list_equal( [
      ...
      f'{tmp_dir}/wine/bin/wscript',
      f'{tmp_dir}/wine/src/barolo.py',
    ], refactor_ast.resolve_text_files(tmp_dir) )
  ...
  def test_match_files(self):
    ...
    ], refactor_ast.match_files( file_find.find(tmp_dir, relative = False), 'kiwi', options = options) )
  ...
  def test_rename_dirs_one_file(self):
    ...
    options = refactor_options(word_boundary = False)
    refactor_ast.rename_dirs(tmp_dir, 'kiwi', 'chocolate', options = options)
    self.assert_filename_list_equal( [
      'chocolate',
      'chocolate/xdata2',
  ...
  def test_rename_dirs_without_word_boundary(self):
    ...
    options = refactor_options(word_boundary = False)
    refactor_ast.rename_dirs(tmp_dir, 'fruit', 'cheese', options = options)
    self.assert_filename_list_equal( [
      'empty_rootdir',
      'kiwi',
      'kiwi/xdata2',
  ...
  def test_rename_dirs_wont_leak_above_root_dir(self):
    ...
    options = refactor_options(word_boundary = False)
    refactor_ast.rename_dirs(path.join(tmp_dir, 'fruit'), 'fruit', 'cheese', options = options)
    self.assert_filename_list_equal( [
      'fruit',
      'fruit/cheese',
      'fruit/cheese/lib',
  ...
  def test_rename_files(self):
    ...
    options = refactor_options(word_boundary = False)
    refactor_ast.rename_files(tmp_dir, 'kiwi', 'chocolate', options = options)
    self.assert_filename_list_equal( [
      'chocolate',
      'chocolate/xdata2',
      'chocolate/xdata2/chocolate_stuff2',
  ...
  def test_rename_dirs_caca(self):
    ...
    options = refactor_options(word_boundary = False)
    refactor_ast.rename_dirs(tmp_dir, 'kiwi', 'kiwifruit', options = options)
    self.assert_filename_list_equal( [
      'kiwifruit',
      'kiwifruit/xdata2',
  ...
  def test_copy_files(self):
    ...
    options = refactor_options(word_boundary = False)
    items = refactor_ast.copy_files(tmp_dir, 'kiwi', 'chocolate', options = options)
    self.assert_filename_list_equal( [
