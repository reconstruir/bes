...
class test_bf_file_resolver(unit_test):
  ...
  def _resolve_with_stats(self, items, **options):
    resolver_options = bf_file_resolver_options(**options)
    tmp_dir = self._make_temp_content(items)
    f = bf_file_resolver(options = resolver_options)
    result = f.resolve_with_stats(tmp_dir)
  ...
  def test_resolve_with_max_depth(self):
    ...
    self.assert_filename_list_equal( sorted([
      '1a.f',
      '1b.f',
    ]), self._resolve(content, max_depth = 1).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1a.f',
      '1b.f',
      '1.d/2a.f',
      '1.d/2b.f',
    ]), self._resolve(content, max_depth = 2).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1a.f',
      '1b.f',
      '1.d/2a.f',
      ...
      '1.d/2.d/3a.f',
      '1.d/2.d/3b.f',
    ]), self._resolve(content, max_depth = 3).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1a.f',
      '1b.f',
      '1.d/2a.f',
      ...
      '1.d/2.d/3.d/4a.f',
      '1.d/2.d/3.d/4b.f',
    ]), self._resolve(content, max_depth = 4).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1a.f',
      '1b.f',
      '1.d/2a.f',
  ...
  def test_resolve_with_min_depth(self):
    ...
    self.assert_filename_list_equal( sorted([
      ...
      '1.d/2.d/3.d/4.d/5a.f',
      '1.d/2.d/3.d/4.d/5b.f',
    ]), self._resolve(content, min_depth = 1).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1.d/2a.f',
      '1.d/2b.f',
      '1.d/2.d/3a.f',
      ...
      '1.d/2.d/3.d/4.d/5a.f',
      '1.d/2.d/3.d/4.d/5b.f',
    ]), self._resolve(content, min_depth = 2).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1.d/2.d/3a.f',
      '1.d/2.d/3b.f',
      '1.d/2.d/3.d/4a.f',
      ...
      '1.d/2.d/3.d/4.d/5a.f',
      '1.d/2.d/3.d/4.d/5b.f',
    ]), self._resolve(content, min_depth = 3).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1.d/2.d/3.d/4a.f',
      '1.d/2.d/3.d/4b.f',
      '1.d/2.d/3.d/4.d/5a.f',
      '1.d/2.d/3.d/4.d/5b.f',
    ]), self._resolve(content, min_depth = 4).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1.d/2.d/3.d/4.d/5a.f',
      '1.d/2.d/3.d/4.d/5b.f',
  ...
  def test_resolve_with_min_and_max_depth(self):
    ...
    self.assert_filename_list_equal( sorted([
      ...
      '1.d/2a.f',
      '1.d/2b.f',
    ]), self._resolve(content, min_depth = 1, max_depth = 2).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1.d/2a.f',
      '1.d/2b.f',
      '1.d/2.d/3a.f',
      '1.d/2.d/3b.f',
    ]), self._resolve(content, min_depth = 2, max_depth = 3).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1.d/2a.f',
      '1.d/2b.f',
    ]), self._resolve(content, min_depth = 2, max_depth = 2).sorted_relative_filenames )
    self.assert_filename_list_equal( sorted([
      '1a.f',
      '1b.f',
  ...
  def xtest_resolve_with_broken_symlink_without_ignore_broken_links(self):
    content = [
      'file fruit/kiwi.fruit',
      'file fruit/lemon.fruit',
      'file fruit/strawberry.fruit',
    ...
    with self.assertRaises(OSError) as context:
      self._resolve(content, ignore_broken_links = False)
  ...
  def test_resolve_with_stats_file_only(self):
    ...
    result = self._resolve_with_stats(content,
                                   file_type = 'FILE',
                                   match_type = 'all')
    self.assert_filename_list_equal( [
      '.git/HEAD',
  ...
  def xtest_resolve_with_stats_dir_only(self):
    content = [
      'file .git/HEAD "x"',
      'file .git/config "x"',
      'file .git/description "x"',
  ...
  def test_resolve_with_match_pattern_and_file_type(self):
    ...
    self.assert_filename_list_equal( [
      'a/b/c/foo.txt',
      'd/e/bar.txt',
    ], self._resolve(content, file_type = 'file',  file_matcher = matcher, match_type = 'all').sorted_relative_filenames )
