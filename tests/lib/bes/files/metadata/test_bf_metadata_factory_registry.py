...
#    bf_metadata_factory_registry.unregister_factory(_test_fruits_factory)
  ...
  def test_register_attr_factory(self):
    self.assertEqual( True, bf_metadata_factory_registry.has_handler('acme/fruit/kiwi/1.0') )
    self.assertEqual( False, bf_metadata_factory_registry.has_handler('acme/fruit/kiwi/2.0') )
    self.assertEqual( False, bf_metadata_factory_registry.has_handler('acme/fruit/cherry/1.0') )
    self.assertEqual( True, bf_metadata_factory_registry.has_handler('acme/fruit/cherry/2.0') )
