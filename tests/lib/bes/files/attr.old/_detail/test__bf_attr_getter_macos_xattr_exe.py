...
if host.is_macos():
  ...
  class _test_super_class_macos_xattr_exe(_bf_attr_getter_macos_xattr_exe, _bf_attr_mixin):
    pass
  
  class test__bf_attr_getter_macos_xattr_exe(make_test_case(_test_super_class_macos_xattr_exe)):
