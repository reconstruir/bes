...
from bes.files.bfile_glob import bfile_glob
from bes.fs.testing.temp_content import temp_content

class test_bfile_glob(unit_test):
  ...
  def test_glob(self):
    ...
    ], bfile_glob.glob(path.join(tmp_dir, 'drinks/alcohol'), '*.config') )
  ...
  def test_glob_search_path(self):
    ...
    ], bfile_glob.glob(search_path, '*.config') )
  ...
  def test_has_glob_pattern_true(self):
    self.assertTrue( bfile_glob.has_glob_pattern('*.py') )
    self.assertTrue( bfile_glob.has_glob_pattern('*.??') )

  def test_has_glob_pattern_false(self):
    self.assertFalse( bfile_glob.has_glob_pattern('foo.py') )
