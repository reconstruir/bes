...
from bes.fs.file_mime_type_detector import HAS_PUREMAGIC
...
if HAS_PUREMAGIC:
  ...
  class test__file_mime_type_detector_puremagic(make_test_case(_file_mime_type_detector_puremagic)):
    ...
    def setUpClass(clazz):
      unit_test_class_skip.raise_skip_if(HAS_PUREMAGIC, 'puremagic not found')

    def test_text_plain(self):
      tmp = self.make_temp_file(content = 'this is text\n', suffix = '.txt')
      self.assertEqual( None, _file_mime_type_detector_puremagic.detect_mime_type(tmp) )
