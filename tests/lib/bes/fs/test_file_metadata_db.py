...
class test_file_metadata(unit_test):
  ...
  def test_get_values_empty(self):
    ...
    self.assertEqual( False, db._db._db.has_table(db._table_name(tmp_file)) )
  ...
  def test_clear(self):
    ...
    print('table_name: {}'.format(db._table_name(tmp_file)))
    self.assertEqual( True, db._db._db.has_table(db._table_name(tmp_file)) )
    db.clear(tmp_file)
    self.assertEqual( [], db.get_values(tmp_file) )
    self.assertEqual( False, db._db._db.has_table(db._table_name(tmp_file)) )
