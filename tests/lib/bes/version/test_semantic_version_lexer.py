...
def TDONE(x = 1, y = 1): return lexer_token(semantic_version_lexer.TOKEN_DONE, None, point(x, y))
def TTEXT(s, x = 1, y = 1): return lexer_token(semantic_version_lexer.TOKEN_TEXT, s, point(x, y))
def TPUNCT(s, x = 1, y = 1): return lexer_token(semantic_version_lexer.TOKEN_PUNCTUATION, s, point(x, y))
def TNUM(s, x = 1, y = 1): return lexer_token(semantic_version_lexer.TOKEN_NUMBER, s, point(x, y))
