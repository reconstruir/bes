...
'''
    bat = self.make_temp_file(content = script, perm = 0o0755)
    rv = execute.execute(bat, shell = False, raise_error = False, non_blocking = True)
    self.assertEqual( 0, rv.exit_code )
    self.assert_string_equal_fuzzy( r'''
this_is_stdout 1
this_is_stdout 2
...
'''
    bat = self.make_temp_file(content = script, perm = 0o0755)
    rv = execute.execute(bat, shell = False, raise_error = False, non_blocking = True, stderr_to_stdout = True)
    self.assertEqual( 0, rv.exit_code )
    self.assert_string_equal_fuzzy( r'''
this_is_stderr 1
this_is_stdout 1
