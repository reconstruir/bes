...
'''
    ...
    self.assertEqual( ( 'ubuntu', '18', 'debian' ), P.parse_os_release(text, '<unittest>') )
...
BUG_REPORT_URL="http://bugs.alpinelinux.org"'''
    ...
    self.assertEqual( ( 'alpine', '3', 'alpine' ), P.parse_os_release(text, '<unittest>') )
...
'''
    self.assertEqual( ( 'raspbian', '8', 'debian' ), P.parse_os_release(text, '<unittest>') )
