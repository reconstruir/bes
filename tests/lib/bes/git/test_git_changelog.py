...
class test_truncate_changelog(unit_test):
  ...
  def test_no_truncation(self):
    ...
    original_log = self.data('result/log_no_truncation.txt', codec='utf-8', xp_new_lines = True)
  ...
  def test_disable_date(self):
    ...
    original_log = self.data('result/log_disable_date.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
    self.assertEqual(original_log, result_log)
  ...
  def test_disable_author(self):
    ...
    original_log = self.data('result/log_disable_author.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
    self.assertEqual(original_log, result_log)
  ...
  def test_disable_date_and_author(self):
    ...
    original_log = self.data('result/log_disable_date_and_author.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
    self.assertEqual(original_log, result_log)
  ...
  def test_truncate_revisions_1(self):
    ...
    for max_chars in range(5668, 4148, -1):
      ...
      original_log = self.data('result/log_truncate_revisions_1.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_revisions_7(self):
    ...
    for max_chars in range(5668, 4381, -1):
      ...
      original_log = self.data('result/log_truncate_revisions_7.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_revisions_10(self):
    ...
    for max_chars in range(5668, 4498, -1):
      ...
      original_log = self.data('result/log_truncate_revisions_10.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_date(self):
    ...
    for max_chars in range(4381, 3182, -1):
      ...
      original_log = self.data('result/log_truncate_date.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_author(self):
    ...
    for max_chars in range(3182, 2770, -1):
      result_log = git_changelog.truncate_changelog(list_of_commit_info, options(max_chars=max_chars))
      original_log = self.data('result/log_truncate_author.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_one_merge_commit(self):
    ...
    for max_chars in range(2770, 2730, -1):
      result_log = git_changelog.truncate_changelog(list_of_commit_info, options(max_chars=max_chars))
      original_log = self.data('result/log_truncate_one_merge_commit.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_all_merge_commits(self):
    ...
    for max_chars in range(2310, 2270, -1):
      result_log = git_changelog.truncate_changelog(list_of_commit_info, options(max_chars=max_chars))
      original_log = self.data('result/log_truncate_all_merge_commits.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_one_message(self):
    ...
    for max_chars in range(2270, 2260, -1):
      result_log = git_changelog.truncate_changelog(list_of_commit_info, options(max_chars=max_chars))
      original_log = self.data('result/log_truncate_one_message.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_five_messages(self):
    ...
    for max_chars in range(2125, 2056, -1):
      result_log = git_changelog.truncate_changelog(list_of_commit_info, options(max_chars=max_chars))
      original_log = self.data('result/log_truncate_five_messages.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_one_line(self):
    ...
    for max_chars in range(1510, 1492, -1):
      result_log = git_changelog.truncate_changelog(list_of_commit_info, options(max_chars=max_chars))
      original_log = self.data('result/log_truncate_one_line.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_five_lines(self):
    ...
    for max_chars in range(1420, 1402, -1):
      result_log = git_changelog.truncate_changelog(list_of_commit_info, options(max_chars=max_chars))
      original_log = self.data('result/log_truncate_five_lines.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_with_new_drop_message(self):
    ...
    for max_chars in range(1420, 1402, -1):
      ...
      original_log = self.data('result/log_truncate_with_new_drop_message.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_message_chars_9(self):
    ...
    for max_chars in range(1420, 1402, -1):
      ...
      original_log = self.data('result/log_truncate_message_chars_9.txt', codec='utf-8', xp_new_lines = True)
      original_log = original_log.strip()
      self.assertEqual(original_log, result_log)
  ...
  def test_truncate_max_chars_200(self):
    ...
    original_log = self.data('result/log_truncate_max_chars_100.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
    self.assertEqual(original_log, result_log)
...
class test_truncate_changelogs(unit_test):
  ...
  def test_three_repos_no_truncation(self):
    ...
    original_log = self.data('result/log_three_repos_no_truncation.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
  ...
  def test_three_repos_max_chars_2000(self):
    ...
    original_log = self.data('result/log_three_repos_max_chars_2000.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
    self.assertEqual(original_log, result)
  ...
  def test_three_repos_max_chars_1000(self):
    ...
    original_log = self.data('result/log_three_repos_max_chars_1000.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
    self.assertEqual(original_log, result)
  ...
  def test_three_repos_max_chars_500(self):
    ...
    original_log = self.data('result/log_three_repos_max_chars_500.txt', codec='utf-8', xp_new_lines = True)
    original_log = original_log.strip()
    self.assertEqual(original_log, result)
