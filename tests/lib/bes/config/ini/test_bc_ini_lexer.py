  ...
  def test_multi_line_crlf(self):
    t = self.call_lex_all(bc_ini_lexer, '''\r\nfruit=kiwi\r\ncolor=green\r\n;comment\r\n''', 
      [
        ...
        ( 't_comment', 'comment', ( 2, 4 ), None, None ),
        ( 't_line_break', '[CR][NL]', ( 9, 4 ), 'h_line_break', None ),
        ( 't_done', None, None, 'h_done', None ),
      ])
    self.assertMultiLineEqual( t.expected, t.actual )
    self.assertMultiLineEqual( t.expected_source_string, t.actual_source_string )
...
''', 
      [
        ( 't_line_break', '[NL]', ( 1, 1 ), 'h_line_break', None ),
        ( 't_section_name_begin', '[', ( 1, 2 ), None, None ),
        ( 't_section_name', 'fruit.1', ( 2, 2 ), None, None ),
        ( 't_section_name_end', ']', ( 9, 2 ), None, None ),
        ( 't_line_break', '[NL]', ( 10, 2 ), 'h_line_break', None ),
        ( 't_key', 'name', ( 1, 3 ), None, None ),
        ( 't_key_value_delimiter', '=', ( 5, 3 ), None, None ),
        ( 't_value', 'kiwi', ( 6, 3 ), None, None ),
        ( 't_line_break', '[NL]', ( 10, 3 ), 'h_line_break', None ),
        ( 't_key', 'color', ( 1, 4 ), None, None ),
        ( 't_key_value_delimiter', '=', ( 6, 4 ), None, None ),
        ( 't_value', 'green', ( 7, 4 ), None, None ),
        ( 't_line_break', '[NL]', ( 12, 4 ), 'h_line_break', None ),
        ( 't_done', None, None, 'h_done', None ),
      ])
    self.assertMultiLineEqual( t.expected, t.actual )
    self.assertMultiLineEqual( t.expected_source_string, t.actual_source_string )
...
''', 
      [
        ...
        ( 't_section_name', 'fruit.1', ( 2, 2 ), None, None ),
        ( 't_section_name_end', ']', ( 9, 2 ), None, None ),
        ( 't_space', '[SP]', ( 10, 2 ), None, None ),
        ( 't_comment_begin', ';', ( 11, 2 ), None, None ),
        ( 't_comment', ' this is fruit 1', ( 12, 2 ), None, None ),
        ( 't_line_break', '[NL]', ( 28, 2 ), 'h_line_break', None ),
        ( 't_key', 'name', ( 1, 3 ), None, None ),
        ( 't_key_value_delimiter', '=', ( 5, 3 ), None, None ),
        ( 't_value', 'kiwi', ( 6, 3 ), None, None ),
        ( 't_line_break', '[NL]', ( 10, 3 ), 'h_line_break', None ),
...
''', 
      [
        ...
        ( 't_value', 'green', ( 7, 4 ), None, None ),
        ( 't_line_break', '[NL]', ( 12, 4 ), 'h_line_break', None ),
        ( 't_line_break', '[NL]', ( 1, 5 ), 'h_line_break', None ),
        ( 't_section_name_begin', '[', ( 1, 6 ), None, None ),
        ( 't_section_name', 'fruit.2', ( 2, 6 ), None, None ),
        ( 't_section_name_end', ']', ( 9, 6 ), None, None ),
        ( 't_line_break', '[NL]', ( 10, 6 ), 'h_line_break', None ),
        ( 't_key', 'name', ( 1, 7 ), None, None ),
        ( 't_key_value_delimiter', '=', ( 5, 7 ), None, None ),
        ( 't_value', 'lemon', ( 6, 7 ), None, None ),
        ( 't_line_break', '[NL]', ( 11, 7 ), 'h_line_break', None ),
        ( 't_key', 'color', ( 1, 8 ), None, None ),
        ( 't_key_value_delimiter', '=', ( 6, 8 ), None, None ),
        ( 't_value', 'yellow', ( 7, 8 ), None, None ),
        ( 't_line_break', '[NL]', ( 13, 8 ), 'h_line_break', None ),
        ( 't_done', None, None, 'h_done', None ),
      ])
    self.assertMultiLineEqual( t.expected, t.actual )
    self.assertMultiLineEqual( t.expected_source_string, t.actual_source_string )
...
''', 
      [
        ( 't_line_break', '[NL]', ( 1, 1 ), 'h_line_break', None ),
        ( 't_comment_begin', ';', ( 1, 2 ), None, None ),
        ( 't_comment', ' fruit', ( 2, 2 ), None, None ),
        ( 't_line_break', '[NL]', ( 8, 2 ), 'h_line_break', None ),
        ( 't_key', 'name', ( 1, 3 ), None, None ),
        ( 't_key_value_delimiter', '=', ( 5, 3 ), None, None ),
        ( 't_value', 'kiwi', ( 6, 3 ), None, None ),
        ( 't_line_break', '[NL]', ( 10, 3 ), 'h_line_break', None ),
