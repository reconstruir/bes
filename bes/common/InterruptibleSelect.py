...
import os, select, unittest
import threading
from Decorator import synchronized_method

class InterruptibleSelect(object):
  'Class to parse lines of serial output'
...
class InterruptibleSelectUnitTest(unittest.TestCase):
