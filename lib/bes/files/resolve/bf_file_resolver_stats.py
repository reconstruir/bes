...
class bf_file_resolver_stats(namedtuple('bf_file_resolver_stats', 'num_checked, num_files_checked, num_dirs_checked, start_time, end_time, depth')):
...
check.register_class(bf_file_resolver_stats, include_seq = False)
