...
from bes.bat_vmware.bat_vmware_server_cli_args import bat_vmware_server_cli_args
from bes.bat_vmware.bat_vmware_session_cli_args import bat_vmware_session_cli_args
...
COMMON_COMMAND_GROUPS = [
  ...
  cli_command('bat_vmware_preferences', 'bat_vmware_preferences_add_args', 'Deal with vmware preferences', bat_vmware_preferences_cli_args),
  cli_command('bat_vmware_server', 'bat_vmware_server_add_args', 'Deal with vmware server', bat_vmware_server_cli_args),
  cli_command('bat_vmware_session', 'bat_vmware_session_add_args', 'Deal with vmware session', bat_vmware_session_cli_args),
