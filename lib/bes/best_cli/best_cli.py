...
class best_cli(cli):
  ...
  from bes.vmware.vmware_rest_cli_args import vmware_rest_cli_args
  COMMON_COMMAND_GROUPS = [
    ...
    cli_command('vmware_rest', 'vmware_rest_add_args', 'Deal with vmware vmrest', vmware_rest_cli_args),
  ]
