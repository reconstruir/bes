...
class best_cli(cli):
  ...
  from bes.vmware.vmware_vmrest_cli_args import vmware_vmrest_cli_args
  COMMON_COMMAND_GROUPS = [
    ...
    cli_command('vmware_vmrest', 'vmware_vmrest_add_args', 'Deal with vmware vmrest', vmware_vmrest_cli_args),
  ]
