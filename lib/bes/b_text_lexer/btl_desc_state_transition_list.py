...
from .btl_desc_state_transition import btl_desc_state_transition
from .btl_parsing import btl_parsing

class btl_desc_state_transition_list(type_checked_list):

  __value_type__ = btl_desc_state_transition
  ...
  def parse_node(clazz, n, source = '<unknown>'):
    ...
    result = btl_desc_state_transition_list()
    for child in n.children:
      next_desc_state_transition = btl_desc_state_transition.parse_node(child, source)
