...
class btask_progress(namedtuple('btask_progress', 'task_id, current, total')):
  
  def __new__(clazz, task_id, current, total):
    ...
    return clazz.__bases__[0].__new__(clazz, task_id, current, total)
