...
class btask_process_data(namedtuple('btask_process_data', 'name, input_queue, output_queue, nice_level, initializer, initializer_args')):
  
  def __new__(clazz, name, input_queue, output_queue, nice_level = None,
    ...
    return clazz.__bases__[0].__new__(clazz, name, input_queue, output_queue,
