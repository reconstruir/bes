...
class pipenv_project_config(object):
  ...
  @property
  def python_exe(self):
    return self._config.get_value_with_default('pipenv_project', 'python_exe', None)
  ...
  def python_exe(self, python_exe):
    return self._config.set_value('pipenv_project', 'python_exe', python_exe)
