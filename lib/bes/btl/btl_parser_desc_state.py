...
class btl_parser_desc_state(namedtuple('btl_parser_desc_state', 'name, transitions, is_end_state')):
  ...
  def parse_node(clazz, n, end_state, source = '<unknown>'):
    ...
    return btl_parser_desc_state(name, transitions, name == end_state)
