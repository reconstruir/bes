...
from .btl_lexer_desc_error import btl_lexer_desc_error

class btl_lexer_desc_error_list(type_checked_list):

  __value_type__ = btl_lexer_desc_error
  ...
  def parse_node(clazz, n, source = '<unknown>'):
    ...
    result = btl_lexer_desc_error_list()
    if not n:
      return result
